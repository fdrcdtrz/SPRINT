...
if __name__ == '__main__':
    ...
    pareto_solutions = cut_and_solve(services, resources, normalized_kpi, normalized_kvi, weighted_sum_kpi, weighted_sum_kvi, Q_N, Q_I, delta=0.1, max_iters=10, tolerance=1e-5, cost_threshold=1)
